<xsl:stylesheet version="2.0"
    ...
    <xsl:import href="19115-3-resources/utility/create19115-3Namespaces.xsl"/>
    <xsl:import href="19115-3-resources/utility/dateTime.xsl"/>
    <xsl:import href="19115-3-resources/utility/multiLingualCharacterStrings.xsl"/>
    ...
    <xsl:include href="19115-3-resources/mapping/core.xsl"/>
    <xsl:include href="19115-3-resources/mapping/CI_ResponsibleParty.xsl"/>
    <xsl:include href="19115-3-resources/mapping/CI_Citation.xsl"/>
    <xsl:include href="19115-3-resources/mapping/SRV.xsl"/>
    <xsl:include href="19115-3-resources/mapping/DQ.xsl"/>
